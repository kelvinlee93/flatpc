<!--footer start-->
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
          ...
          nCloneTd.innerHTML = '<img src="<?=base_url()?>static/admin/assets/advanced-datatable/examples/examples_support/details_open.png">';
          ...
          $('#hidden-table-info tbody td img').live('click', function () {
              ...
              if ( oTable.fnIsOpen(nTr) )
              {
                  ...
                  this.src = "<?=base_url()?>static/admin/assets/advanced-datatable/examples/examples_support/details_open.png";
                  oTable.fnClose( nTr );
              }
              else
              {
                  /* Open this row */
                  this.src = "<?=base_url()?>static/admin/assets/advanced-datatable/examples/examples_support/details_close.png";
